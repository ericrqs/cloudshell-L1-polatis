...
class PolatisDefaultCommandMode(CommandMode):
    PROMPT_REGEX = r'>\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             PolatisDefaultCommandMode.PROMPT_REGEX,
                             PolatisDefaultCommandMode.ENTER_COMMAND,
                             PolatisDefaultCommandMode.EXIT_COMMAND)


class PolatisEnableCommandMode(CommandMode):
    PROMPT_REGEX = r'#\s*$'
    ENTER_COMMAND = ''
    EXIT_COMMAND = 'exit'
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             PolatisEnableCommandMode.PROMPT_REGEX,
                             PolatisEnableCommandMode.ENTER_COMMAND,
                             PolatisEnableCommandMode.EXIT_COMMAND)


class PolatisConfigCommandMode(CommandMode):
    ...
    def __init__(self):
        CommandMode.__init__(self,
                             PolatisConfigCommandMode.PROMPT_REGEX,
                             PolatisConfigCommandMode.ENTER_COMMAND,
                             PolatisConfigCommandMode.EXIT_COMMAND)


CommandMode.RELATIONS_DICT = {
    PolatisDefaultCommandMode: {
        PolatisEnableCommandMode: {
            PolatisConfigCommandMode: {
            }
        }
    }
}
...
# c = PolatisCliConnection(get_qs_logger(), 'tl1', '10.99.99.230', 3082, 'root', 'root', 1)
